...
return new class extends Migration
{
    ...
    {
        DB::statement('ALTER TABLE event_records DROP CONSTRAINT event_type_check');
        DB::statement('ALTER TABLE event_records DROP CONSTRAINT failure_type_check');
        DB::statement('ALTER TABLE event_records DROP CONSTRAINT event_parameters_check');
        DB::statement(
        /** @lang PostgreSQL */
