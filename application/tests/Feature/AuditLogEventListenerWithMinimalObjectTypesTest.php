 ...
 */
class AuditLogEventListenerWithMinimalObjectTypesTest extends AuditLogEventListenerBaseTest
{
    /** @dataProvider provideAllObjectTypes */
    public function test_remove_object_with_all_object_types(ObjectType $objectType)
    {
        $body = ObjectTypeBasedMinimalBodyCreators::buildObjectIdentityReferenceMessage(EventType::RemoveObject, $objectType);
    ...
    {
        $body = ObjectTypeBasedMinimalBodyCreators::buildObjectIdentityReferenceMessage(EventType::CreateObject, $objectType);
        $this->assertEventConsumption($body);
    }
    ...
    {
        $body = ObjectTypeBasedMinimalBodyCreators::buildModifyObjectMessage($objectType);
        $this->assertEventConsumption($body);
    }
