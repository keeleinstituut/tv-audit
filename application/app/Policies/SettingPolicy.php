...
class SettingPolicy
{
     ...
     */
    public function view(mixed $user, Setting $setting): bool
    {
        return $setting->institution_id == $user->institutionId;
    }
     ...
     */
    public function update(mixed $user, Setting $setting): bool
    {
        return $setting->institution_id == $user->institutionId && 
            Auth::hasPrivilege(PrivilegeKey::EditAuditLogSettings->value);
    }
     ...
     */
    public function restore(mixed $user, Setting $setting): bool
    {
        //
    }
     ...
     */
    public function forceDelete(mixed $user, Setting $setting): bool
    {
        //
    }
