...
#[OA\Schema(
    title: 'Event record whose parameters describe an attempt to modify an object',
    allOf: [
        ...
        new OA\Schema(
            ...
            properties: [
                ...
                new OA\Property(
                    ...
                    oneOf: [
                        new OA\Schema(allOf: [
                            new OA\Schema(ref: EventRecords\ModifyObjectEventParametersCommonSchema::class),
...
class ModifyObjectEventRecordSchema
{
}
